                ...
                <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="card col m-1" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text fw-bold">Rp.<?php echo e($d->price); ?></p>
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div class="counter">
                                    <div class="btn-group" role="group" aria-label="Basic example">
                                        ...
                                        <form action="/food/<?php echo e($d->food_id); ?>" method="POST" enctype="multipart/form-data">
                                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Asus\OneDrive\Documents\Semester 5\Web Programming\tugas_glsc\resources\views/search.blade.php ENDPATH**/ ?>